...
const infinite = (useSWRNext)=>(getKey, fn, config)=>{
        ...
        index_js.useSyncExternalStore(ReactExports.useCallback((callback)=>{
        ...
        const mutate = ReactExports.useCallback(// eslint-disable-next-line func-names
        function(data, opts) {
        ...
        // Extend the SWR API
        const setSize = ReactExports.useCallback((arg)=>{
            // It is possible that the key is still falsy.
            if (!infiniteKey) return EMPTY_PROMISE;
